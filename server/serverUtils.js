module.exports = {
  //custom util function to parse a stream of shoes data, calculate the avgTrueToSize, then store it in
  //an obj (in memory). This obj which holds shoes data will be inserted to database
